...
function completeMap(mapArray)
{
    ...
    if (dataCom)
    {
        //var sign = document.getElementById("yadata")[0].value;
        mapDraw = mapDouglasCom(mapDraw, comNum);
    }
...
function setCom()
{
    var obj = document.getElementById("yadata"); //定位id
    comNum = obj.value; //选中地区的编号
    //对画布进行重绘
